          ...
          <div class="el-picker-panel__content el-date-range-picker__content is-left">
            <div class="el-date-range-picker__header">
              <button
                type="button"
                @click="prevYear"
                class="jo-icon jo-icon-double-arrow-left el-picker-panel__icon-btn"></button>
              <button
                type="button"
                @click="prevMonth"
                class="jo-icon jo-icon-left-arrow el-picker-panel__icon-btn"></button>
              <div>{{ leftLabel }}</div>
            </div>
            <date-table
          ...
          <div class="el-picker-panel__content el-date-range-picker__content is-right">
            <div class="el-date-range-picker__header">
              <button
                type="button"
                @click="nextYear"
                class="jo-icon jo-icon-double-arrow-right el-picker-panel__icon-btn"></button>
              <button
                type="button"
                @click="nextMonth"
                class="jo-icon jo-icon-right-arrow el-picker-panel__icon-btn"></button>
              <div>{{ rightLabel }}</div>
            </div>
            <date-table
              selection-mode="range"
